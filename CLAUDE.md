...
| Run tooling against a target | Kali VM over SSH: `bash ~/.torch/vm.sh '<cmd>'` (VPN route + tools + chromium live there) -> `docs/virtual-machine.md` |
